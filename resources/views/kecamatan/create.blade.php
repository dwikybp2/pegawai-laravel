      ...
      <div class="card-content p-3">
        <form action="{{ route('kecamatan.store') }}" method="post">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="kode" id="kode" class="form-control @error('kode') is-invalid @enderror" value="{{ old('kode') }}"  placeholder="Masukkan Kode Kecamatan" required>
            @error('kode')
          ...
          <div class="mb-3">
            ...
            <input type="text" name="nama" id="nama" class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama') }}" placeholder="Masukkan Nama Kecamatan" required>
            @error('nama')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
