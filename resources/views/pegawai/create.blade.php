      ...
      <div class="card-content p-3">
        <form action="{{ route('pegawai.store') }}" method="post">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="nama" id="nama" class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama') }}" placeholder="Masukkan Nama Pegawai" required>
            @error('nama')
          ...
          <div class="mb-3">
            ...
            <input type="text" name="tempat_lahir" id="tempat_lahir" class="form-control @error('tempat_lahir') is-invalid @enderror" value="{{ old('tempat_lahir') }}"  placeholder="Masukkan Kode Pegawai" required>
            @error('tempat_lahir')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
          ...
          <div class="mb-3">
            ...
            <input type="date" name="tanggal_lahir" id="tanggal_lahir" class="form-control @error('tanggal_lahir') is-invalid @enderror" value="{{ old('tanggal_lahir') }}"  placeholder="Masukkan Kode Pegawai" required>
            @error('tanggal_lahir')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
          ...
          <div class="mb-3">
            ...
            <div class="form-check-inline">
              <input class="form-check-input" type="radio" name="jenis_kelamin" id="jenis_kelamin1" value="1" checked>
          ...
          <div class="mb-3">
            ...
            <input type="text" name="agama" id="agama" class="form-control @error('agama') is-invalid @enderror" value="{{ old('agama') }}"  placeholder="Masukkan Kode Pegawai">
            @error('agama')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
